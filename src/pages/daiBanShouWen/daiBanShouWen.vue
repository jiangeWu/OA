...
<script>
	...
	export default {
		...
		methods: {
			...
			loadTodoList() {
				let that = this;
				that.$http.post('api-office/receivefile/commonform/todoList',that.todoList,function(response) {
			...
			loadWasList() {
				let that = this;
				that.$http.post('api-office/receivefile/commonform/wasList',that.wasList,function(response) {
