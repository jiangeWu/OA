		...
		<div v-if="!messShow && !ifMail" v-show="!loading">
			<div class="fawen">
				<div class="fawen-primary">
					<p class="fawen-banli" @click="Tab2"><span :class="{bot3: fawen}" data-id="">发文办理</span></p>
					<p class="fawen-guocheng" @click="Tab"><span :class="{bot3: banli}" data-id="">办理过程</span></p>
				</div>
			</div>
			<!-- 办理过程 -->
			<div  v-show="fawen" class="fawen-wrap">
					...
					<div class="fawen-content" >
						<div class="fawen-content-primary">
							<p class="font15 docViewName">
								...
								<a class="fr" :href="'http://192.168.8.225:8080/api-office/office/sendfile/downLoadDocFile?formId='+formId+'&token='+token">{{bastInfo.docViewName}}</a>
							</p>
						</div>
					...
					<div class="fawen-content" v-for="(file,index) in fileList">
						<div class="fawen-content-primary">
							<p class="font15 oldFileName">
								...
								<a class="fr" :href="'http://192.168.9.24:8080/api-office/office/sendfile/downLoadFile?fileId='+file.attachmentId+'&formId='+formId+'&token='+token">{{file.oldFileName}}</a>
							</p>
					...
					<div v-if="!isSignIn">
						...
						<div class="fawen-content" @click="shouJianRen('下一环节')" v-if="nextNodeItemList.length > 0">
							<div class="fawen-content-primary">
								<p class="font15">
									<span>下一环节</span>
									<a class="fr">{{nextNodeItemListNameShow}}</a>
								</p>
							</div>
							<div class="fawen-content-ft"></div>
						</div>
