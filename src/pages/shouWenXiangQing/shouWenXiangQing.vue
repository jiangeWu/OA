					...
					<div class="fawen-content" >
						<div class="fawen-content-primary">
							<p class="font15 docViewName">
								...
								<a class="fr" :href="'http://13512799741.imwork.net:23605/api-office/receivefile/commonform/downLoadDocFile?formId='+formId+'&token='+token">{{bastInfo.docViewName}}</a>
							</p>
						</div>
					...
					<div class="fawen-content" v-for="(file,index) in fileList">
						<div class="fawen-content-primary">
							<p class="font15 oldFileName">
								...
								<a class="fr" :href="'http://13512799741.imwork.net:23605/api-office/receivefile/commonform/downLoadFile?fileId='+file.attachmentId+'&formId='+formId+'&token='+token">{{file.oldFileName}}</a>
							</p>
